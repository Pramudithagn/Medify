...
export const mockDataTreatments = [
  ...
  },
  {
    ...
    description:
      "A treatment program designed to improve cardiovascular health.",
    price: 750.0,
    status: true,
    doctorIds: [107, 108],
  },
  ...
  },
  {
    ...
    description:
      "A treatment to help people participate in the things they want and need to do through therapeutic use of everyday activities.",
    price: 120.0,
    status: true,
    doctorIds: [111],
  },
  {
    ...
    name: "Speech Therapy",
    description:
      "A treatment that helps with speech, language, and swallowing disorders.",
    price: 80.0,
    status: true,
    doctorIds: [112, 113],
  },
  {
    ...
    description:
      "A treatment focusing on disorders of the musculoskeletal system and the nervous system.",
    price: 90.0,
    status: false,
  ...
  },
  {
    ...
    name: "Acupuncture",
    description:
      "A treatment involving the insertion of thin needles through the skin at specific points.",
    price: 70.0,
    status: true,
    doctorIds: [117],
  },
  {
    ...
    description:
      "A treatment focusing on improving health through a well-balanced diet.",
    price: 60.0,
    status: true,
    doctorIds: [118, 119],
  },
...
export const mockDataRecords = [
...

  {
    id: 15,
    diagnosis: "Eczema",
    prescription: "Hydrocortisone cream 1% for 2 weeks",
    price: 120,
    treatmentIds: [5, 12],
  },
  {
    ...
    prescription: "Methimazole 10mg daily",
    price: 400,
    treatmentIds: [3, 9],
  },
  {
    ...
    prescription: "Tobramycin eye drops, 4 times daily for 7 days",
    price: 90,
    treatmentIds: [6, 10],
  },
  {
    ...
    prescription: "Ibuprofen 800mg as needed",
    price: 230,
    treatmentIds: [2, 9],
  },
  {
  ...
  },
  {
    id: 22,
    diagnosis: "Anxiety",
    prescription: "Escitalopram 10mg once daily",
    price: 190,
    treatmentIds: [5, 8],
  },
];
